    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Tambah Produk Hukum</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <form action="" method="POST" class="form" id="produkhukum-form">
            @csrf
            <input type="hidden" name="_token" autocomplete="off"> <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <textarea name="judul" class="form-control" id="judul-form" cols="30" rows="3"></textarea>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <textarea name="tentang" class="form-control" id="tentang-form" cols="30" rows="3"></textarea>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <textarea name="hasil_uji_materi" class="form-control" id="hasil_uji_materi-form" cols="30" rows="3"></textarea>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            function fetchWhitelist(query) {
                if (query.length >= 1) { // Only fetch if input length >= 1
                    $.ajax({
                        url: "{{ route('master-produk-hukum.subjekSelect') }}",
                        type: "GET",
                        data: {
                            search: query
                        }, // Pass user input as query parameter
                        success: function(data) {
                            subjek.settings.whitelist = data; // Update whitelist
                            subjek.dropdown.show(); // Show the dropdown with new data
                        },
            ...
            subjek.on('input', debounce(function(e) {
                var value = e.detail.value; // Current user input
                fetchWhitelist(value);
            }, 300));
            ...
            $('#tipe_dokumen_id-form').on('change', function() {
                ...
                if (tipeDokumenId) {
                    ...
                    initSelect2('{{ route('master-jenis-dokumen.jenisDokumenSelect') }}',
                        '#jenis_dokumen_id-form', tipeDokumenId);
                } else {
            ...
            $('#tipe_dokumen_id-form-modal').on('change', function() {
                ...
                if (tipeDokumenId) {
                    ...
                    initSelect2('{{ route('master-jenis-dokumen.jenisDokumenSelect') }}',
                        '#jenis_dokumen_id-form-modal', tipeDokumenId);
                } else {
