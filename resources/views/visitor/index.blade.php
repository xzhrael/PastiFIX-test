                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                        ...
                        <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                            ...
                            <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link"
                                            ...
                                            target="_blank" title="Dasar Hukum JDIH"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover"
                                            data-bs-dismiss="click" data-bs-placement="right">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link"
                                            ...
                                            data-bs-toggle="tooltip" data-bs-trigger="hover"
                                            data-bs-dismiss="click" data-bs-placement="right">
                                            <span class="menu-title">Tentang JDIH</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Anggota JDIH</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Tim Pengelola JDIH</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Kedudukan & Alamat</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Dokumen Hukum Terjemahan</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Intruksi Gubernur</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-title">Peraturan/Keputusan Kepala OPD</span>
                                        ...
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Peraturan Kepala OPD</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Keputusan Kepala OPD</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Dokumen Kerjasama</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-title">Propem</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <!--end:Menu link-->
                                        <!--begin:Menu sub-->
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Propempergub</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Propemperda</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Dokumen Hukum Langka</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                ...
                                <!--begin:Menu link-->
                                <span class="menu-link">
                                    <span class="menu-title">Monografi Hukum</span>
                                    <span class="menu-arrow d-lg-none"></span>
                                </span>
                                <!--end:Menu link-->
                                <!--begin:Menu sub-->
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Naskah Akademik</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Raperda</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Rapergub</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Hasil Harmonisasi</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-title">Hasil Fasilitasi</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <!--end:Menu link-->
                                        <!--begin:Menu sub-->
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Hasil Fasilitasi Raperda Provinsi</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Hasil Fasilitasi Raperda Kabupaten/Kota</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Analisis dan Evaluasi Hukum</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Gubernur/Wakil Gubernur</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Sekretaris Daerah</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link" href="#">
                                                    <span class="menu-title">Kepala OPD</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">RANHAM</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="#">
                                            <span class="menu-title">Buku Hukum</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <!--begin:Menu link-->
                                <a href="#" class="menu-link">
                                    <span class="menu-title">Artikel Hukum</span>
                                    <span class="menu-arrow d-lg-none"></span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <!--begin:Menu link-->
                                <a href="#" class="menu-link">
                                    <span class="menu-title">Putusan</span>
                                    <span class="menu-arrow d-lg-none"></span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="index.html" class="menu-link active">
                                                                    ...
                                                                    <span class="d-flex flex-column">
                                                                        <span
                                                                            class="fs-6 fw-bold text-gray-800">Layanan 1</span>
                                                                        <span
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/ecommerce.html" class="menu-link">
                                                                    ...
                                                                    <span class="d-flex flex-column">
                                                                        <span
                                                                            class="fs-6 fw-bold text-gray-800">Layanan 2</span>
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/projects.html" class="menu-link">
                                                                    ...
                                                                    <span class="d-flex flex-column">
                                                                        <span
                                                                            class="fs-6 fw-bold text-gray-800">Layanan 3</span>
                                                                        <span
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/online-courses.html"
                                                                    ...
                                                                    <span class="d-flex flex-column">
                                                                        <span class="fs-6 fw-bold text-gray-800">Layanan 4</span>
                                                                        <span
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <!--begin:Menu sub-->
                                <div
                                    class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">                                    <!--begin:Menu item-->
                                    <div class="menu-item p-0 m-0">
                                        <!--begin:Menu link-->
                                        <a href="#" class="menu-link">
                                            ...
                                            <div class="card-header align-items-center border-0 mt-4">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                        data-kt-menu="true" id="kt_menu_66b9a9c927722">
                                                        <!--begin::Header-->
                                                        <div class="px-7 py-5">
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <div>
                                                                    <select class="form-select form-select-solid"
                                                                        ...
                                                                        data-dropdown-parent="#kt_menu_66b9a9c927722"
