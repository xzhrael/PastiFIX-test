                            ...
                            <tbody>
                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <div
                                                ...
                                                <p
                                                    ...
                                                    Hey {{$user->name}}, terimakasih telah memverifikasi email!</p>
                                            </div>
                                            <!--end:Text-->
                                            <!--begin:Action-->
                                            <a href="{{ $verificationUrl }}"
                                                style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">Verifikasi Email</a>
                                            <!--begin:Action-->
                                        </div>
                                        <!--end:Email content-->
                                    </td>
                                ...
                                <tr style="display: flex; justify-content: center; margin:0 60px 35px 60px">
                                    <td align="start" valign="start" style="padding-bottom: 10px;">
                                        <p
                                            style="color:#181C32; font-size: 18px; font-weight: 600; margin-bottom:13px">
                                            Apa selanjutnya?</p>
                                        <!--begin::Wrapper-->
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="{{ route('user-profile.index') }}"
                                                            style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Lengkapi profil akun anda</a>
                                                        <!--end::Title-->
                                                        <!--begin::Desc-->
                                                        <p
                                                            style="color:#5E6278; font-size: 13px; font-weight: 500; padding-top:3px; margin:0;font-family:Arial,Helvetica,sans-serif">
                                                            Lengkapi profil akun anda dan gunakan aplikasi ini secara bijak</p>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                    <!--begin::Separator-->
                                                    <div class="separator separator-dashed"
                                                        style="margin:17px 0 15px 0"></div>
                                                    <!--end::Separator-->
                                                </div>
                                                <!--end::Block-->
                                            </div>
