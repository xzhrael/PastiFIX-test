...
class BidangHukumController extends CrudController
{
    public function init()
    {
        $this->table = 'ms_dokumen_bidang_hukum';
        $this->module = "master-bidang-hukum";
        $this->title = "Bidang Hukum";
        $this->subtitle = "Home / Bidang Hukum";
    ...
    public function bidHukumSelect(Request $request)
    {
        $searchTerm = $request->input('q');

        $data = BidangHukum::where('name', 'like', "%$searchTerm%");
