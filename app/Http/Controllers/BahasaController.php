...
class BahasaController extends CrudController
{
    public function init()
    {
        $this->table = 'ms_dokumen_bahasa';
        $this->module = "master-bahasa";
        $this->title = "Bahasa";
        $this->subtitle = "Home / Bahasa";
    ...
    public function bahasaSelect(Request $request)
    {
        $searchTerm = $request->input('q');

        $data = Bahasa::where('name', 'like', "%$searchTerm%");
